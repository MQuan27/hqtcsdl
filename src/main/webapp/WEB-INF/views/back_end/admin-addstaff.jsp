...
<body>
	...
	<div id="wrapper">
				...
				<ul class="nav navbar-nav side-nav">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li class="active"><a href="${contextPage }/manage/staff">Nhân Viên</a></li>
		...
		<div id="page-wrapper">
			<form method="post" action="${contextPage }/manage/addStaff" class="form-horizontal"
					...
					<div class="form-group">
						...
						<div class="col-sm-6" id="gend">
							<label class="radio-inline"> <input type="radio"
								value="Nam" name="gender" required="required" data-error="Hãy chọn giới tính!"> Nam
